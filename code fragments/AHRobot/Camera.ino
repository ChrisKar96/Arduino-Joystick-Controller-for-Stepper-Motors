...
void cameraProcess(int posX, int posY, int time)
{
  ...
  coordY = ROBOT_CENTER_Y - coordY*cam_pix_to_mmy;
  coordX = ROBOT_CENTER_X - coordX*cam_pix_to_mmx*(1-cam_rotation);
...
void cameraProcessInit()
{
  ...
  cam_pix_to_mmy = CAM_PIX_TO_MMY;
  cam_pix_to_mmx = CAM_PIX_TO_MMX;
