...
#define MIN_ACCEL_X 60 //60
#define MAX_ACCEL_X 360   //360 //300//320      // Maximun motor acceleration in (steps/seg2)/1000
#define MIN_ACCEL_Y 60 //60
#define MAX_ACCEL_Y 220    //140//220 
...
#define ROBOT_MIN_X 105
#define ROBOT_MIN_Y 120
#define ROBOT_MAX_X 490
#define ROBOT_MAX_Y 450
...
#define ROBOT_INITIAL_POSITION_Y 120   // Measured from center of the robot pusher to the table border

// Robot defense and attack lines
#define ROBOT_DEFENSE_POSITION 120
#define ROBOT_DEFENSE_ATTACK_POSITION 450
...
#define CAM_PIX_TO_MMY 1.48    // Camera scale To calculate, you need to measure two points with known coordinates
#define CAM_PIX_TO_MMX 1.13
//original 1.48
...
#define MISSING_STEPS_MAX_ERROR_X 8 //8
#define MISSING_STEPS_MAX_ERROR_Y 10 //10
#define ROBOT_POSITION_CAMERA_CORRECTION_Y -20 //-20 // Correction of the position of the camera because the camera point of view and mark position
