...
#define PIN_STEP A0             // stepper step pin
#define PIN_DIR A1             // stepper dir pin
...
void loop() {
  ...
  if(stepper.isStopped()){
    ...
    if(counter % 2 == 0){
      ...
      stepper.step(MOTORSTEPS, CLOCKWISE, rpmToTickInterval(180));
    } /*else {
      //do a full rotation clockwise at 10rpm
      stepper.step(MOTORSTEPS, ANTICW, rpmToTickInterval(150));
    }*/
